...
def get_similar_question_objects(es_hosts, es_index, es_type, question, subject, num_answers):
...
def get_answers(es_hosts, es_index, es_type, question, subject, num_answers):
  ...
  question_docs = get_similar_question_objects(es_hosts, es_index, es_type, question, subject, num_answers)
...
if __name__ == "__main__":
  ...
  parser.add_argument('--subject', help='The input subject for the question we want to answer.', default=None)
  ...
  parser.add_argument('--num_answers', help='Number of answers that will be returned', type=int, default=5)
  args = parser.parse_args()

  answers = get_answers(args.es_hosts, args.es_index, args.es_type, args.question, args.subject, args.num_answers)
